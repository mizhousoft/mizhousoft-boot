package com.mizhousoft.boot.shiro.realm;
...
import com.mizhousoft.boot.shiro.GrantedAuthority;
import com.mizhousoft.boot.shiro.authc.UnionAuthenticationToken;
import com.mizhousoft.boot.shiro.exception.BadCredentialsException;
...
public class AuthenticationRealm extends AuthorizingRealm
{
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException
	{
		...
		catch (com.mizhousoft.boot.shiro.exception.AuthenticationException e)
		{
			LOG.error("Account authenticate failed, message: {}", e.getMessage());

			if (e instanceof com.mizhousoft.boot.shiro.exception.AccountDisabledException)
			{
				throw new DisabledAccountException(e.getMessage(), e);
			}
			else if (e instanceof com.mizhousoft.boot.shiro.exception.BadCredentialsException)
			{
				String message = null;
			...
			else if (e instanceof com.mizhousoft.boot.shiro.exception.AccountLockedException)
			{
