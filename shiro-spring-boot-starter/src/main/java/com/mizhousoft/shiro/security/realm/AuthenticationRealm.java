package com.mizhousoft.shiro.security.realm;
...
import com.mizhousoft.shiro.security.GrantedAuthority;
import com.mizhousoft.shiro.security.authc.UnionAuthenticationToken;
import com.mizhousoft.shiro.security.exception.BadCredentialsException;
import com.mizhousoft.shiro.security.service.AccountAuthcService;
...
public class AuthenticationRealm extends AuthorizingRealm
{
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException
	{
		...
		catch (com.mizhousoft.shiro.security.exception.AuthenticationException e)
		{
			LOG.error("Account authenticate failed, message: {}", e.getMessage());

			if (e instanceof com.mizhousoft.shiro.security.exception.AccountDisabledException)
			{
				throw new DisabledAccountException(e.getMessage(), e);
			}
			else if (e instanceof com.mizhousoft.shiro.security.exception.BadCredentialsException)
			{
				String message = null;
			...
			else if (e instanceof com.mizhousoft.shiro.security.exception.AccountLockedException)
			{
